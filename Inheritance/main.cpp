...
void testDiamondInherit()
{
    ...
    cout<<"pViBaseRVir @ "<< dynamic_cast<void *>(pViBaseRVir)<<endl;
    cout<<"pViBaseRVir @ "<< static_cast<void *>(pViBaseRVir)<<endl;
    cout<<"pViBaseRVir @ "<< (void *)pViBaseRVir<<endl;
    cout<<"pViBaseRVir @ 0x"<< hex<< (int)pViBaseRVir<<endl;
}
